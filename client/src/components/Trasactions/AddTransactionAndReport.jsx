...
const AddTransactionAndReport = () => {
   ...
   return (
      <div className="p-6 bg-slate-200 text-black rounded-md w-full">
         <h2 className="text-lg sm:text-xl font-semibold mb-4">Quick Actions</h2>
         <div className="flex justify-center w-full">
            <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 gap-4 w-full">
               {/* Add New Transaction Button */}
               <button
                  className="flex items-center p-4 bg-slate-300 rounded-lg shadow-md hover:bg-slate-400 transition cursor-pointer"
               ...
               >
                  ...
                  <span className="text-sm sm:text-base font-medium break-words whitespace-normal overflow-visible">+ Add Transaction</span>
               </button>

               {/* View Transaction Report Button */}
               <button className="flex items-center p-4 bg-slate-300 rounded-lg shadow-md hover:bg-slate-400 transition cursor-pointer">
                  ...
                  <span className="text-sm sm:text-base font-medium break-words whitespace-normal overflow-visible">View Reports</span>
               </button>
            </div>
         </div>
