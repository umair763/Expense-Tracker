         ...
         <div className="p-6 bg-slate-200 text-black rounded-md w-full">
            ...
            <div className="flex justify-center w-full">
               <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-2">
                  {/* New Expense Button */}
                  <button
                     className="flex items-center p-4 bg-teal-300 rounded-lg shadow-md hover:bg-teal-400 transition"
                  ...
                  <button className="flex items-center p-4 bg-teal-300 rounded-lg shadow-md hover:bg-teal-400 transition">
